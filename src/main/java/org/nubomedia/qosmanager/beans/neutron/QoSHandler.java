...
package org.nubomedia.qosmanager.beans.neutron;
...
public class QoSHandler {
     ...
     */
    public String neutron_http_connection(String t_url,String method,Access access,JSONObject payload){
    ...
    public JSONObject createPolicyPayload(String name){
        // TODO : catch null objects
        JSONObject tmp = new JSONObject("{\"policy\":{\"name\":\""+name+"\",\"description\":\"generated by connectivity manager\",\"shared\":\"true\"}}");
    ...
    public JSONObject createBandwidthLimitRulePayload(String max_rate){
        // TODO : catch null objects
        JSONObject tmp = new JSONObject("{\"bandwidth_limit_rule\":{\"max_kbps\":\""+max_rate+"\"}}");
